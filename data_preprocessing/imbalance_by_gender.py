...
def balance_datasets(root_dir, save_dir, croping_sites):
    ...
    for (Y_data, X_data), (site, _, _) in zip(balanced_datasets, croping_sites):        # noqa
        ...
        Y_data.to_csv(save_dir + "Y_" + site + "_gender_imbalance_extreme.csv",
                      index=False)
        X_data.to_csv(save_dir + "X_" + site + "_gender_imbalance_extreme.csv",
                      index=False)
...
balance_datasets(root_dir, save_dir, croping_sites)
