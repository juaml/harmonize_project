...
data_dir = "/data/ADNI/ADNI_experiments/"       # noqa
X, Y, sites = load_ADNI(data_dir, site_target_independance=False)
...
result_df.to_csv(project_root+save_dir+"ADNI_results_dependance.csv")
# %%
